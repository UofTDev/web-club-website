...
<div class="container-extend grey" id="team">
    <div class="container">
        <div class="hero-unit">
            <h2>Executive Team - 2014/2015</h2>
            ...
            <div class="team-list">
                <div class = "team-description">
                    <p>President/Co-Founder - Emad Alaydi (2012-2014)</p>
                </div>
                <div class = "team-description">
                    <p>VP/Co-Founder - Mahmoud Kochaji (2012-2014)</p>
                </div>
                <div class = "team-description">
                    <p>VP Strategy - Ahmed Badr (2012-2014)</p>
                </div>
                <div class = "team-description">
                    <p>VP Marketing - Valentin Staykov (2012-2014)</p>
                </div>
                <div class = "team-description">
                    <p>Web Director/Co-Founder - Haneef Ghanim (2012-2013)</p>
                </div>
                <div class = "team-description">
                    <p>iOS Director - Tamer Abdulazim (2012-2013)</p>
                </div>
                <div class = "team-description">
                    <p>iOS Director - Francis Lata (2013-2014)</p>
                </div>
                <div class = "team-description">
                    <p>Design Director - Amr Ahmed  (2012-2013)</p>
                </div>
            </div>
        </div>
    </div>
