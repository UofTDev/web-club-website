...
<div class="container-extend grey" id="contact">
    <div class="container">
        <h2>Have questions or want to get more information?</h2>
        <ul>
            <li>General inquiries: <a href="mailto:info@uoftdev.ca">info@uoftdev.ca</a></li>
